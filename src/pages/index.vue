...
import Watson from "../components/mixins/watson-mixin";
import Azure from "../components/mixins/azure-mixin";
import Aws from "../components/mixins/aws-mixin";

@Component({ name: "Index" })
export default class Index extends mixins(Azure) {
  bckModalOpen = false;
